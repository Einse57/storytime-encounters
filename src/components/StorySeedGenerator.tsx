...
export const StorySeedGenerator: React.FC = () => {
  ...
  return (
    <div className="bg-[#fcf7ec] rounded-xl shadow-xs border border-[#d9c49e] p-3 sm:p-4 relative">
      ...
      <div className="flex justify-between items-center mb-2.5">
        ...
        <button
          ...
          className="btn-tactile bg-gradient-to-b from-[#b45309] via-[#92400e] to-[#78350f] hover:from-[#d97706] hover:to-[#92400e] text-amber-100 font-serif font-bold text-xs py-1.5 px-3.5 rounded-full border border-[#fde68a]/70 shadow-xs flex items-center gap-1.5 cursor-pointer"
      ...
      <div className={`space-y-2 transition-opacity duration-200 ${isAnimating ? 'opacity-50' : 'opacity-100'}`}>
        {/* Setting */}
        <div className={`bg-white/80 border ${seed.isSettingLocked ? 'border-amber-500 bg-amber-50/90' : 'border-amber-200/80'} rounded-lg px-2.5 py-1.5 flex justify-between items-center gap-2 transition-all`}>
          <div className="flex-1 min-w-0">
            ...
            <p className="text-gray-900 font-serif text-xs sm:text-sm leading-tight capitalize truncate">
              {seed.setting || 'Generating setting...'}
            </p>
          </div>
          <button
            onClick={() => toggleLock('setting')}
            className={`btn-tactile p-1.5 rounded-md text-xs transition-all flex-shrink-0 cursor-pointer ${
              seed.isSettingLocked
        ...
        {/* Conflict */}
        <div className={`bg-white/80 border ${seed.isConflictLocked ? 'border-rose-500 bg-rose-50/90' : 'border-rose-200/80'} rounded-lg px-2.5 py-1.5 flex justify-between items-center gap-2 transition-all`}>
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 mb-0.5">
            ...
            <p className="text-gray-900 font-serif text-xs sm:text-sm leading-tight truncate">
        ...
        {/* Hook */}
        <div className={`bg-white/80 border ${seed.isHookLocked ? 'border-blue-500 bg-blue-50/90' : 'border-blue-200/80'} rounded-lg px-2.5 py-1.5 flex justify-between items-center gap-2 transition-all`}>
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 mb-0.5">
